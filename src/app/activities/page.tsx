...
export default async function ActivitiesPage() {
  const [activities, testimony, impactStats] = await Promise.all([
    getActivities(),
...
async function ImpactBanner({
  ...
  const t = await getTranslations("activitiesPage");
  const stats = [
    { icon: HeartHandshake, value: statsData.soulsWon, label: t("impactSouls"), suffix: "" },
    { icon: Flame, value: statsData.crusades, label: t("impactCrusades"), suffix: "" },
    { icon: GraduationCap, value: statsData.schoolsVisited, label: t("impactSchools"), suffix: "" },
    { icon: Users, value: statsData.missionaries, label: t("impactVolunteers"), suffix: "" },
  ];
  return (
